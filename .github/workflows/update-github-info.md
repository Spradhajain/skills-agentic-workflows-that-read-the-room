...
Use the official GitHub Blog, Changelog, and Awesome Copilot workflows pages as sources for any new information. Keep summaries short and practical, and include the source URL for each update. Update only `site/content/github-info.md`; preserve its existing editorial structure and avoid unrelated changes.
